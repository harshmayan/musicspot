...
import { convertSecToTime } from "@/helpers";
...
const PlayerContent: React.FC<PlayerContentProps> = ({
  ...
  useEffect(() => {
    // Check if audio exists before using it
    if (audio) {
        audio.play();
        setMediaSession();
        return () => {
...
}, [isPlaying, updateMediaPosition, audio, getDuration, updateRangeValue]);
